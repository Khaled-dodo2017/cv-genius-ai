    ...
    form.addEventListener(
      ...
      async event => {
        ...
        try {
          ...
          const cvText = `
${currentLanguage === 'ar' ? 'الاسم' : currentLanguage === 'fr' ? 'Nom' : 'Name'}: ${getValue('fullName')}

${currentLanguage === 'ar' ? 'الوظيفة المستهدفة' : currentLanguage === 'fr' ? 'Poste recherché' : 'Target Job'}: ${getValue('targetJob')}

${currentLanguage === 'ar' ? 'المسمى الوظيفي' : currentLanguage === 'fr' ? 'Intitulé du poste' : 'Job Title'}: ${getValue('jobTitle')}

${currentLanguage === 'ar' ? 'البريد الإلكتروني' : currentLanguage === 'fr' ? 'E-mail' : 'Email'}: ${getValue('email')}

${currentLanguage === 'ar' ? 'الهاتف' : currentLanguage === 'fr' ? 'Téléphone' : 'Phone'}: ${getValue('phone')}

${currentLanguage === 'ar' ? 'الموقع' : currentLanguage === 'fr' ? 'Localisation' : 'Location'}: ${getValue('location')}

${currentLanguage === 'ar' ? 'الملخص' : currentLanguage === 'fr' ? 'Résumé' : 'Summary'}:
${getValue('summary')}

${currentLanguage === 'ar' ? 'الخبرة' : currentLanguage === 'fr' ? 'Expérience' : 'Experience'}:
${experience
  .map(item =>
...
${currentLanguage === 'ar' ? 'التعليم' : currentLanguage === 'fr' ? 'Formation' : 'Education'}:
${education
  .map(item =>
...
${currentLanguage === 'ar' ? 'المهارات' : currentLanguage === 'fr' ? 'Compétences' : 'Skills'}:
${getValue('skills')}

${currentLanguage === 'ar' ? 'اللغات' : currentLanguage === 'fr' ? 'Langues' : 'Languages'}:
${getValue('languages')}
          `.trim();
          ...
          /*
             مهم:
             النتيجة أصبحت محفوظة حتى يمكن
             استخدامها لاحقاً دون فقدانها.
          */
          ...
          /*
             إذا أعاد الـBackend نسخة CV كاملة
             وكان العنصر موجوداً، نعرض النتيجة.
          */
